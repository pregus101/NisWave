...
class SongBar:
    ...
    def draw(self):
        if self.total_length > 0:
            ...
            pygame.draw.rect(self.screen, (128, 128, 128), (int(((self.screen_width-self.screen_width/5)/2+self.screen_width/5)-self.bar_width_hight/2), int((self.screen_height/2+10+40*2)+self.bar_width_hight/2), self.bar_width_hight, 6))
            pygame.draw.rect(self.screen, (64, 255, 64), (int(((self.screen_width-self.screen_width/5)/2+self.screen_width/5)-self.bar_width_hight/2), int((self.screen_height/2+10+40*2)+self.bar_width_hight/2), self.current_bar_width, 6))
            ...
            self.screen.blit(text_surface, (int(((self.screen_width-self.screen_width/5)/2+self.screen_width/5)+self.bar_width_hight/2)+20, int((self.screen_height/2+10+40*2)+self.bar_width_hight/2)-4))
    ...
    def adjust_time(self, mouse_position):
        ...
        relative_y = mouse_position[1] - int((self.screen_height/2+10+40*2)+self.bar_width_hight/2)
